...
def test_lines():
    ...
    assert ass._translate_line("0;JMP").code == 0b1110101010000111
    assert ass._translate_line("M=1").code == 0b1110111111001000
    assert ass._translate_line("D=M").code == 0b1111110000010000

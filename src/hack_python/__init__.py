...
INSTRUCTION_SET = [
    ...
    (0b000_1101, "!D", lambda m: HACK_MASK ^ m.D.get()),  # not sure if this is right
    (0b011_0001, "!A", lambda m: HACK_MASK ^ m.A.get()),
    (0b000_1111, "-D", lambda m: -m.D.get()),  # not sure if this is right TC: (0xFFFF^v)+1
    ...
    (0b111_0001, "!M", lambda m: HACK_MASK ^ m.ram[m.A.get()]),
